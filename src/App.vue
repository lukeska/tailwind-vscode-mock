<template>
	<div class="max-w-7xl mx-auto bg-gray-800 rounded-lg">
		<div class="py-3 border-b border-gray-500/30">
			<div class="flex space-x-1.5 px-3">
		...
		<div class="flex">
			...
			<div class="w-full overflow-hidden">
				<PrismCode>{{`<div class="w-full flex items-center justify-between block p-6 space-x-6">
  <div class="flex-1 truncate">
    <div class="flex items-center space-x-3">
      <h3 class="text-gray-900 text-sm font-medium truncate">Jane Cooper</h3>
      <span class="text-teal-600 bg-teal-400">Admin</span>
    </div>
    <p class="mt-1 text-gray-500 text-sm truncate">Regional Paradigm Technician</p>
  </div>
  <img class="w-10 h-10 bg-gray-300 rounded-full shrink-0" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=4&amp;w=256&amp;h=256&amp;q=60" alt="">
</div>
  ...
  <div class="-mt-px flex">
    <div class="w-0 flex-1 flex border-r border-gray-200">
      <a href="#" class="relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-gray-700 font-medium border border-transparent rounded-bl-lg hover:text-gray-500 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 focus:z-10 transition ease-in-out duration-150">
        ...
        <span class="ml-3">Email</span>`}}</PrismCode>

				<div
					class="border-t border-gray-500/30 font-mono text-gray-200 text-xs p-4 space-y-2"
				>
					<h3>Problems</h3>
					<ul class="text-gray-300 space-y-1">
						<li class="flex space-x-2 items-center">
							<svg
								...
								height="24"
								fill="none"
								class="flex-none text-yellow-400"
							>
								<path
							...
							<p class="text-gray-500">cssConflict [1, 20]</p>
						</li>
						<li class="flex space-x-2 items-center">
							<svg
								width="24"
							...
							<p class="text-gray-500">cssConflict [1, 54]</p>
						</li>
					</ul>
				</div>
			</div>
